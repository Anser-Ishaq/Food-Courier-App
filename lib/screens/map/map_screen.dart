...
import 'package:food_couriers/screens/map/widgets/current_location_button.dart';
                      ...
                      Column(
                        children: [
                          ...
                          CurrentLocationButton(
                            onTap: () {
                              mapProvider.getLocationUpdates(currentButton: true);
                            },
                          ),
                        ],
                      ),
                      LocationDetailsBox(
                        locationAddress: mapProvider.stAddress ?? 'Loading....',
                      ),
                    ],
                  ),
                ),
